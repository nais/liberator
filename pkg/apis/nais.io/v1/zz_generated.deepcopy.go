...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Salsa) DeepCopyInto(out *Salsa) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Salsa.
func (in *Salsa) DeepCopy() *Salsa {
	if in == nil {
		return nil
	}
	out := new(Salsa)
