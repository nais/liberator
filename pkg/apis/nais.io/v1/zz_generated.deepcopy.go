...
func (in *Cleanup) DeepCopyInto(out *Cleanup) {
	*out = *in
	if in.Strategy != nil {
		...
		*out = make([]CleanupStrategy, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CloudSqlDatabaseFlag) DeepCopyInto(out *CloudSqlDatabaseFlag) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CloudSqlDatabaseFlag.
func (in *CloudSqlDatabaseFlag) DeepCopy() *CloudSqlDatabaseFlag {
	if in == nil {
		return nil
	}
	out := new(CloudSqlDatabaseFlag)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CloudSqlInstance) DeepCopyInto(out *CloudSqlInstance) {
	*out = *in
	...
	if in.DatabaseFlags != nil {
		...
		*out = make([]CloudSqlDatabaseFlag, len(*in))
		copy(*out, *in)
	}
}
