...
func (in *MaskinportenScope) DeepCopyInto(out *MaskinportenScope) {
	*out = *in
	if in.UsedScope != nil {
		in, out := &in.UsedScope, &out.UsedScope
		*out = make([]UsedScope, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UsedScope) DeepCopyInto(out *UsedScope) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UsedScope.
func (in *UsedScope) DeepCopy() *UsedScope {
	if in == nil {
		return nil
	}
	out := new(UsedScope)
