...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Texas) DeepCopyInto(out *Texas) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Texas.
func (in *Texas) DeepCopy() *Texas {
	if in == nil {
		return nil
	}
	out := new(Texas)
