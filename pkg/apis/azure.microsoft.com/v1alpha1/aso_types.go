...
import (
	azure_microsoft_com_api "github.com/nais/liberator/pkg/apis/azure.microsoft.com"
...
type ASOStatus struct {
	...
	PollingURLKind     *azure_microsoft_com_api.PollingURLKind`json:"pollingUrlKind,omitempty"`
...
func (s *ASOStatus) SetPollingURL(url string, kind azure_microsoft_com_api.PollingURLKind) {
	s.PollingURL = url
