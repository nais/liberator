...
func (in *AdditionalStreamUser) DeepCopyInto(out *AdditionalStreamUser) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdditionalStreamUser.
func (in *AdditionalStreamUser) DeepCopy() *AdditionalStreamUser {
	if in == nil {
		return nil
	}
	out := new(AdditionalStreamUser)
	in.DeepCopyInto(out)
	return out
}
...
func (in *StreamSpec) DeepCopyInto(out *StreamSpec) {
	*out = *in
	if in.AdditionalUsers != nil {
		...
		*out = make([]AdditionalStreamUser, len(*in))
		copy(*out, *in)
	}
}
